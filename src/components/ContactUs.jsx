...
export default function ContactUs() {
  ...
  return (
    <>
     ...
     <div className='mt-10'>
     <h1 className='text-[5vw]  font-bold text-center md:text-start '>ContactUs</h1>
        ...
        <div className="flex flex-col md:flex-row">
          <div className='w-full'>
            ...
            <h1 className='md:text-[5vw] text-[5vw] font-bold text-center md:text-start '>Reach Us Directly</h1>
            <p className='flex items-center gap-5 md:text-[2vw] text-[5vw]'><SiGmail />reehaai.ai@gmail.com</p>
            <p className='flex items-center gap-5 md:text-[2vw] text-[5vw]'>
              <FaWhatsapp />
              Whatsapp us “Hi” at
              +916374648490
            </p>
