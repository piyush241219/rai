...
export default function Footer() {
  return (
    <footer className=" text-black-300 py-10">
      ...
      <hr className="my-8 border-gray-700" />
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-6 md:items-start md:gap-10">
          ...
          <div className="flex flex-col items-center md:items-start">
            ...
            <p className="md:text-[2vw] text-[5vw] text-black-400">
              Empowering you with knowledge and connection.
            </p>
          </div>

          {/* Links Section */}
          <div className="flex flex-col gap-4 md:flex-row md:gap-16 md:text-[2vw] text-[5vw]">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center md:items-end">
          <div className="text-center md:text-left md:text-[2vw] text-[5vw]">
