...
export default function About() {
    return (
        <div className="md:px-20">
            <div className='h-[100%] flex items-center justify-around flex-col px-5 pt-5 md:px-20' data-aos="zoom-in" data-aos-duration="1200" data-aos-once>
            ...
            <div>
                <div className="flex flex-col items-center md:flex-row gap-5 md:gap-10 mt-5">
